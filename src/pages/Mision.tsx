    ...
    <div className={clsx("bg-white")}>
      ...
      >
        ...
        <p>
          ...
          medio de conferencias, actividades, charlas. Para enfrentar la
          presente problemática que nos aqueja como sociedad y es el aumento
          exponencial en la población estudiantil de suicidios e intentos de
          suicidio, violencia familiar y escolar, auto lesiones, entre otras.
        </p>
        <br />
        <p>
          ...
          entidades sin ánimo de lucro es dar un apoyo. Desde la fundación
          estamos implementando planes de acción enseñando a los padres y
          maestros a identificar señales de alarma en niños niñas y o
          adolescentes, que los mismos puedan aprender a gestionar adecuadamente
          sus emociones logrando así que nuestros hijos busquen ayuda a tiempo y
        ...
        <p>
          ...
          conferencistas, logística, voluntarios y por supuesto a los rectores
          de cada institución que nos abre sus puertas para enfrentar juntos
          este reto.
        </p>
        <br />
        <p>
